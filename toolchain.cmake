...
if (WIN32)
    ...
    SET(TOOLCHAIN_BIN_DIR "C:/Program Files (x86)/GNU Tools ARM Embedded/7 2017-q4-major/bin")
    SET(TOOLCHAIN_INC_DIR "C:/Program Files (x86)/GNU Tools ARM Embedded/7 2017-q4-major/lib")
    SET(TOOLCHAIN_LIB_DIR "C:/Program Files (x86)/GNU Tools ARM Embedded/7 2017-q4-major/include")
else(WIN32)
    # TARGET_TRIPLET
    SET(TARGET_TRIPLET "arm-none-eabi-")
